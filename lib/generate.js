...
//
// https://github.com/atom/joanna/tree/0acd4d7a0ad0b23727e5dfb7f6e3f7cc88e9c085
//
...
class Generator {
  ...
  visitExportNamedDeclaration (node) {
    if (node.declaration) {
      ...
      for (var each of node.specifiers) {
        // export them
      }
    }
  }
  ...
  getDocumentation () {
    ...
    let lastIsSection = SECTION_REGEX.test(lastComment.value)
    if (!lastIsSection) {
      groupedComments.pop()
    }
